...
function saveDrugName(id){
  ...
  var theUrl="../ash-sweb-2016-group4/View/homepage.php?cmd=5&dc="+id+"&Drugname="+Drugname;
  $.ajax(theUrl,
  {async:true,
...
function saveDrugQuantity(id){
  ...
  var theUrl="../ash-sweb-2016-group4/View/homepage.php?cmd=6&dc="+id+"&DrugQuantity="+DrugQuantity;
  $.ajax(theUrl,
  {async:true,
...
function saveToolName(id){
  ...
  var theUrl="../ash-sweb-2016-group4/View/homepage.php?cmd=7&tc="+id+"&Toolname="+Toolname;
  $.ajax(theUrl,
  {async:true,
...
function saveToolQuantity(id){
  ...
  var theUrl="../ash-sweb-2016-group4/View/homepage.php?cmd=8&tc="+id+"&Toolquantity="+Toolquantity;
  $.ajax(theUrl,
  {async:true,
...
function saveSupplierName(id){
  ...
  var theUrl="../ash-sweb-2016-group4/View/homepage.php?cmd=9&sc="+id+"&SupplierName="+SupplierName;
  $.ajax(theUrl,
  {async:true,
...
function saveSupplierLocation(id){
  ...
  var theUrl="../ash-sweb-2016-group4/View/homepage.php?cmd=10&sc="+id+"&SupplierLocation="+SupplierLocation;
  $.ajax(theUrl,
  {async:true,
